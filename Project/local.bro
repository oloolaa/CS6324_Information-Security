...
# shellshock.bro was written for earlier version of Bro and relies on some deprecated events.
#@load policy/protocols/dhcp/deprecated_events.bro
#@load shellshock

# ja3 - a standard for creating SSL client fingerprints in an easy to produce and shareable way
@load ja3
...
hook Notice::policy(n: Notice::Info)
	...
	if ( n$note == SSH::Password_Guessing )
		...
		$msg=fmt("It appears to be gussing SSH passwords.")]);
	}
